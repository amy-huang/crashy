...
var fileDescriptor_76afcfc1dbadb4c3 = []byte{
	...
	0xce, 0xa8, 0xd4, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x4e, 0x2c, 0xc8, 0x54, 0x52, 0xe2,
	...
	0x8b, 0x8b, 0x13, 0xd3, 0x61, 0xea, 0x60, 0x5c, 0x23, 0x7b, 0x2e, 0x36, 0x67, 0xb0, 0x1d, 0x42,
	0xa6, 0x5c, 0x5c, 0x60, 0x4d, 0x21, 0x19, 0xa9, 0x45, 0xa9, 0x42, 0x82, 0x7a, 0x89, 0x05, 0x99,
	0x7a, 0xc8, 0x36, 0x49, 0x09, 0x21, 0x0b, 0x41, 0x0c, 0x56, 0x62, 0x48, 0x62, 0x03, 0xbb, 0xcd,
	0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x77, 0xdf, 0x27, 0xa1, 0xab, 0x00, 0x00, 0x00,
}
...
func (c *crashyClient) HelloThere(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.Crashy/HelloThere", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Crashy_HelloThere_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Crashy/HelloThere",
	}
