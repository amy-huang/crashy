...
func init() {
	proto.RegisterType((*HelloRequest)(nil), "crashy.HelloRequest")
	proto.RegisterType((*HelloResponse)(nil), "crashy.HelloResponse")
}
...
var fileDescriptor_76afcfc1dbadb4c3 = []byte{
	...
	0xce, 0xa8, 0xd4, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x83, 0xf0, 0x94, 0x94, 0xb8, 0x78,
	...
	0xe2, 0xc4, 0x74, 0x98, 0x3a, 0x18, 0xd7, 0xc8, 0x95, 0x8b, 0xcd, 0x19, 0x6c, 0xb0, 0x90, 0x35,
	0x17, 0x17, 0x58, 0x53, 0x48, 0x46, 0x6a, 0x51, 0xaa, 0x90, 0x88, 0x1e, 0xd4, 0x76, 0x64, 0xcb,
	0xa4, 0x44, 0xd1, 0x44, 0x21, 0xc6, 0x2b, 0x31, 0x24, 0xb1, 0x81, 0x1d, 0x69, 0x0c, 0x08, 0x00,
	0x00, 0xff, 0xff, 0xa5, 0xc9, 0x42, 0x37, 0xb4, 0x00, 0x00, 0x00,
}
...
func (c *crashyClient) HelloThere(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/crashy.Crashy/HelloThere", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Crashy_HelloThere_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/crashy.Crashy/HelloThere",
	}
